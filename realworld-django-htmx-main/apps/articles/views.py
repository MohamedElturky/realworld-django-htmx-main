...
def _build_feed(request, tag=None):
    ...
    # TODO: cache stores the queryset callable result; on cache miss the full
    # tag table is re-evaluated. Invalidate is manual (cache.delete in save).
...
def article_favorite_view(request, slug):
    ...
    # FIXME: any authenticated user can favorite; no rate limiting or
    # notification side effects are handled here.
